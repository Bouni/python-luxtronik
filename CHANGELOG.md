...
- Change the scaling factor of 'ID_Waermemenge' parameters from 0.1 to 0.01 [#198]
- Change the scaling factor of the voltage data type to 0.01 [#198]
